...
<div id="onecard-modal" class="modal">
    <div class="content aqban-modal-one-card aqpago-box-all-payments">
		...
		<fieldset class="fieldset payment items ccard">
			<fieldset class="fieldset aqpago-box-card aqpago-box-card-checkout">
				...
				<div class="modal-new-card" onClick="return AQPAGO.setNewCardModalOne()">
				...
				<div class="aqbank-installment-description">
					<span class="description-installment description-installment-1"></span>
				</div>
				...
				<div class="aqbank-box-parcelas aqbank-multi-pagamento-valor modal-edit-amount" style="display:none;">
					<div class="aqbank-round-parcelas aqbank-round-parcelas-input">
						...
						<input type="tex" id="aqpago_cc_multiple_val_oneCard" class="aqbank-input-valor" />
				...
				<div class="field field-name-lastname">
					<label for="aqpago_cc_number_cardOne" class="label">
						<span>Número do cartão</span>
					</label>
					<div class="control">
						<input type="text" step="0" id="aqpago_cc_number_cardOne" maxlength="19" class="input-text" value=""
							   placeholder="0000 0000 0000 0000" />
					</div>
				</div>
		
				<div class="field field-name-name_card">
					<label for="aqpago_cc_owner_cardOne" class="label">
						<span>Nome impresso cartão</span>
					</label>
					<div class="control">
						<input style="text-transform: uppercase;" id="aqpago_cc_owner_cardOne" type="text" class="input-text" value=""/>
					</div>
				</div>
		
				<div>
					<div class="field valid_month_checkout">
						<label for="aqpago_expiration_cardOne" class="label">
							<span>Validade</span>
						</label>
						<div class="control"> 
								
								<select id="aqpago_expiration_cardOne" class="select select-month input-text card-select valid_month">
								...
								<select id="aqpago_expiration_yr_cardOne" class="select select-year card-select valid_year">
					...
					<div class="field field-name-code-checkout" style="top: 0px !important;">
						<label for="aqpago_cc_cid_cardOne" class="label">
							<span>Código</span>
						</label>
						<div class="control">
							<input type="number" id="aqpago_cc_cid_cardOne"
								   step="0"
								   maxlength="4"
								   autocomplete="off"
				...
				<div class="field field-name-documento documento-one-cardOne">
					...
					<label for="aqpago_documento_cardOne" class="label">
						<span>CPF dono do cartão</span>
					</label>
					<div class="control">
						<input type="text" id="aqpago_documento_cardOne" placeholder="000.000.000-00" title="CPF dono do cartão" class="input-text required-entry" data-validate="{required:true}" aria-required="true">
					</div>
					
				</div>
				
				<div class="field-saved-card"></div>
	...
	<a href="javascript:void(0);" class="modal-button-save" onClick="return saveNewDataCardOne();">Salvar dados</a>
</div>
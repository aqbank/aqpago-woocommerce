...
<div id="twocard-modal" class="modal">
			...
			<fieldset class="fieldset aqpago-box-card aqpago-box-card-checkout">
				...
				<div class="aqbank-box-parcelas aqbank-multi-pagamento-valor modal-edit-amount" style="display:none;">
					<div class="aqbank-round-parcelas aqbank-round-parcelas-input">
						...
						<div class="text-parcelas"><span></span></div>
						<span class="currency-valor">R$</span>
						<input type="tex" id="aqpago_cc_multiple_val_twoCard" class="aqbank-input-valor" />
				...
				<div class="field field-name-lastname">
					<label for="aqpago_cc_number_cardTwo" class="label">
						<span>Número do cartão</span>
					</label>
					<div class="control">
						<input type="text" step="0" id="aqpago_cc_number_cardTwo" maxlength="19" class="input-text" value=""
							   placeholder="0000 0000 0000 0000" />
					</div>
				</div>
				
				<div class="field field-name-name_card">
					<label for="aqpago_cc_owner_cardTwo" class="label">
						<span>Nome impresso cartão</span>
					</label>
					<div class="control">
						<input style="text-transform: uppercase;" id="aqpago_cc_owner_cardTwo" type="text" class="input-text" value="" />
					</div>
				</div>
				
				<div>
					<div class="field valid_month_checkout">
						<label for="aqpago_expiration_cardTwo" class="label">
							<span>Validade</span>
						</label>
						<div class="control"> 
								
								<select id="aqpago_expiration_cardTwo" class="select select-month input-text card-select valid_month">
								...
								<select id="aqpago_expiration_yr_cardTwo" class="select select-year card-select valid_year">
					...
					<div class="field field-name-code-checkout" style="top: 0px !important;">
						<label for="aqpago_cc_cid_cardTwo" class="label">
							<span>Código</span>
						</label>
						<div class="control">
							<input type="number" id="aqpago_cc_cid_cardTwo"
								   step="0"
								   maxlength="4"
								   autocomplete="off"
				...
				<div class="field field-name-documento documento-one-cardTwo">
					<label for="aqpago_documento_cardTwo" class="label">
						<span>CPF dono do cartão</span>
					</label>
					<div class="control">
						<input type="text" id="aqpago_documento_cardTwo" placeholder="000.000.000-00" title="CPF dono do cartão" class="input-text required-entry" />
					</div>
				</div>
	...
	<a href="javascript:void(0);" class="modal-button-save" onClick="return saveNewDataCardTwo();">Salvar dados</a>
</div>
